...
import { getALLSells,getItemsSoldToday,getCashInStock,mapSoldItems,confirmSale,Reportitem,getTotalCashAmount,getTodaySells,getAllitemsSold,getTodayProfit,Perm,getReturnbyid,getsoldItemss,printReceipt} from '../controllers/village_dashboarddata.js';
...
router.get('/printreceipt/',checkAuth, printReceipt);
