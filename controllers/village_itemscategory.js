...
const { VillageItemscategory,VillageAllitems } =db;

export const Category = async(req,res)=>{
    try{
        const category = await VillageItemscategory.findAll()
    ...
    export const getcategoryItem = async (req, res) => {
        ...
        try {
          ...
          const item = await VillageItemscategory.findOne({
            where: { id },
          });
      ...
      export const getcategoryDelete = async (req, res) => {
        ...
        try {
          ...
          const allCategoryItems = await VillageItemscategory.findAll();
      ...
      export const createCategory = async (req, res) => {
        ...
        try {
            ...
            const newCategory = await VillageItemscategory.create({
                name,
                in_stock,
            });
