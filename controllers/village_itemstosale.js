...
export const Getallitems = async(req,res)=>{
    try{
        ...
        const itemsTosale=await VillageAllitems.findAll({
...
export const getItembyid = async (req, res) => {
    ...
    try {
      ...
      const item = await VillageAllitems.findOne({
        where: { id },
      });
  ...
  export const getDeletebyid = async (req, res) => {
    ...
    try {
      ...
      const allItems = await VillageAllitems.findAll();
  ...
  export const createbyid = async (req, res) => {
    ...
    try {
        ...
        const newitems = await VillageAllitems.create({
            name,
            in_stock,
            price,
            buying_price
...
export const getinstockItems =async (req, res) => {
    try{
        ...
        const results = await VillageAllitems.sum("in_stock");
